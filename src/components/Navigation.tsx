      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-1">
            <Button
              asChild
              variant={isActive("/founder-bio") ? "secondary" : "ghost"}
              className={cn(
                "text-primary-foreground hover:text-accent-foreground hover:bg-accent/20",
                isActive("/founder-bio") && "bg-accent text-accent-foreground"
              )}
            >
            ...
            <Button
              asChild
              variant={isActive("/why-pinewoods") ? "secondary" : "ghost"}
              className={cn(
                "text-primary-foreground hover:text-accent-foreground hover:bg-accent/20",
                isActive("/why-pinewoods") && "bg-accent text-accent-foreground"
              )}
            >
