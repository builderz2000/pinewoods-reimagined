    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="relative z-10 text-center text-white px-4 sm:px-6 w-full max-w-4xl mx-auto">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-light leading-tight mb-8 tracking-wide break-words">
        ...
        <div className="container mx-auto max-w-4xl">
          <Card className="p-6 sm:p-8 md:p-12 bg-card/80 backdrop-blur-sm border border-accent/50 text-center">
            <div className="space-y-6">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-light text-foreground tracking-wide break-words">
      ...
      <section className="py-20 px-4 sm:px-6 bg-background">
        <div className="container mx-auto max-w-6xl text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-light text-foreground mb-8 tracking-wide break-words">
          ...
          <Button asChild size="lg" className="bg-accent text-accent-foreground hover:bg-accent/90 text-sm sm:text-base break-words">
            <Link to="/why-pinewoods" className="px-4 py-3">&gt;&gt;Learn More About What Makes Pinewoods Different</Link>
          </Button>
        </div>
      </section>
